...
function [units_PN, resp_mean, resp_std, tuning_curve, units_PN2, ind_NNS, response_tot]...
    = getNumberSensefromNet(nettmp, image_sets_standard, image_sets_control1,image_sets_control2...
